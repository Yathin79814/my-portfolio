    ...
    <section id="videos" className="py-24 px-6 md:px-12 max-w-7xl mx-auto relative z-10">
      <div className="mb-16">
        ...
        <p className="text-[var(--color-secondary)] text-lg">
          Looping landscape reels showcasing AI generation, advanced video editing, and motion design.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {localVideos.map((video, idx) => (
          <motion.div
            ...
            whileHover={{ y: -6 }}
            className="group relative rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl overflow-hidden transition-all duration-300 hover:border-[var(--color-accent)]/50 hover:shadow-[0_0_40px_rgba(235,94,40,0.15)]"
          >
            ...
            <div className="relative aspect-video w-full overflow-hidden bg-black/40">
              ...
              <div className="absolute top-4 left-4 bg-black/60 backdrop-blur-md border border-white/15 px-3 py-1 rounded-full text-[10px] font-semibold uppercase tracking-wider text-[var(--color-accent)] flex items-center gap-1.5 shadow-lg select-none">
                <Play className="w-2.5 h-2.5 fill-current" /> Playing Live
              </div>
            ...
            {/* Content Details */}
            <div className="p-6">
              <h3 className="text-xl font-bold mb-2 text-[#FFFCF2] group-hover:text-[var(--color-accent)] transition-colors">
                {video.title}
              </h3>
